...
from core.api import videos_list, videos_detail_by_slug, videos_detail_by_id, videos_get_likes, videos_get_views, videos_list_recommended, videos_register_view, videos_add_like, videos_add_unlike

urlpatterns = [
  path(
    'api/videos', videos_list, name='api_videos_list'
  ),
